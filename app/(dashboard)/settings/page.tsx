          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              <div key={f.id}>
                ...
                <select id={f.id} defaultValue={f.value} className="w-full px-3 py-2 border border-border rounded-xl text-sm outline-none focus:border-border-strong bg-bg">
        ...
        <div className="bg-surface rounded-2xl border border-border card-shadow p-6">
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              <div key={f.id}>
                <label className="block text-xs font-mono uppercase tracking-widest text-text-muted mb-1.5" htmlFor={f.id}>{f.label}</label>
                <input id={f.id} type="number" defaultValue={f.value} className="w-full px-3 py-2 border border-border rounded-xl text-sm outline-none focus:border-border-strong bg-bg" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-surface rounded-2xl border border-border card-shadow p-6 md:col-span-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={f.id}>
                <label className="block text-xs font-mono uppercase tracking-widest text-text-muted mb-1.5" htmlFor={f.id}>{f.label} (%)</label>
                <input id={f.id} type="number" min="0" max="100" defaultValue={f.value} className={`w-full px-3 py-2 border border-border rounded-xl text-sm outline-none ${f.color} bg-bg`} />
              </div>
            ))}
          </div>
        </div>
